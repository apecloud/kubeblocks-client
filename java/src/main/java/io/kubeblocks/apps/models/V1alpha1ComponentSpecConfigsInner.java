...
import io.kubeblocks.apps.models.V1alpha1ComponentSpecConfigsInnerLegacyRenderedConfigSpec;
...
/**
 * V1alpha1ComponentSpecConfigsInner
 */
...
public class V1alpha1ComponentSpecConfigsInner {
  ...
  private V1alpha1ComponentSpecConfigsInnerLegacyRenderedConfigSpec legacyRenderedConfigSpec;
  ...
  public V1alpha1ComponentSpecConfigsInner() {
  }

  public V1alpha1ComponentSpecConfigsInner asEnvFrom(List<String> asEnvFrom) {
    
    this.asEnvFrom = asEnvFrom;
    return this;
  }

  public V1alpha1ComponentSpecConfigsInner addAsEnvFromItem(String asEnvFromItem) {
  ...
  **/
  ...
  public V1alpha1ComponentSpecConfigsInner constraintRef(String constraintRef) {
  ...
  **/
  ...
  public V1alpha1ComponentSpecConfigsInner defaultMode(Integer defaultMode) {
  ...
  **/
  ...
  public V1alpha1ComponentSpecConfigsInner injectEnvTo(List<String> injectEnvTo) {
    
    this.injectEnvTo = injectEnvTo;
    return this;
  }

  public V1alpha1ComponentSpecConfigsInner addInjectEnvToItem(String injectEnvToItem) {
  ...
  **/
  ...
  public V1alpha1ComponentSpecConfigsInner keys(List<String> keys) {
    
    this.keys = keys;
    return this;
  }

  public V1alpha1ComponentSpecConfigsInner addKeysItem(String keysItem) {
    if (this.keys == null) {
  ...
  **/
  ...
  public V1alpha1ComponentSpecConfigsInner legacyRenderedConfigSpec(V1alpha1ComponentSpecConfigsInnerLegacyRenderedConfigSpec legacyRenderedConfigSpec) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1alpha1ComponentSpecConfigsInnerLegacyRenderedConfigSpec getLegacyRenderedConfigSpec() {
    return legacyRenderedConfigSpec;
  }


  public void setLegacyRenderedConfigSpec(V1alpha1ComponentSpecConfigsInnerLegacyRenderedConfigSpec legacyRenderedConfigSpec) {
    this.legacyRenderedConfigSpec = legacyRenderedConfigSpec;
  }


  public V1alpha1ComponentSpecConfigsInner name(String name) {
  ...
  **/
  ...
  public V1alpha1ComponentSpecConfigsInner namespace(String namespace) {
  ...
  **/
  ...
  public V1alpha1ComponentSpecConfigsInner reRenderResourceTypes(List<ReRenderResourceTypesEnum> reRenderResourceTypes) {
    
    this.reRenderResourceTypes = reRenderResourceTypes;
    return this;
  }

  public V1alpha1ComponentSpecConfigsInner addReRenderResourceTypesItem(ReRenderResourceTypesEnum reRenderResourceTypesItem) {
  ...
  **/
  ...
  public V1alpha1ComponentSpecConfigsInner templateRef(String templateRef) {
  ...
  **/
  ...
  public V1alpha1ComponentSpecConfigsInner volumeName(String volumeName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ComponentSpecConfigsInner v1alpha1ComponentSpecConfigsInner = (V1alpha1ComponentSpecConfigsInner) o;
    return Objects.equals(this.asEnvFrom, v1alpha1ComponentSpecConfigsInner.asEnvFrom) &&
        Objects.equals(this.constraintRef, v1alpha1ComponentSpecConfigsInner.constraintRef) &&
        Objects.equals(this.defaultMode, v1alpha1ComponentSpecConfigsInner.defaultMode) &&
        Objects.equals(this.injectEnvTo, v1alpha1ComponentSpecConfigsInner.injectEnvTo) &&
        Objects.equals(this.keys, v1alpha1ComponentSpecConfigsInner.keys) &&
        Objects.equals(this.legacyRenderedConfigSpec, v1alpha1ComponentSpecConfigsInner.legacyRenderedConfigSpec) &&
        Objects.equals(this.name, v1alpha1ComponentSpecConfigsInner.name) &&
        Objects.equals(this.namespace, v1alpha1ComponentSpecConfigsInner.namespace) &&
        Objects.equals(this.reRenderResourceTypes, v1alpha1ComponentSpecConfigsInner.reRenderResourceTypes) &&
        Objects.equals(this.templateRef, v1alpha1ComponentSpecConfigsInner.templateRef) &&
        Objects.equals(this.volumeName, v1alpha1ComponentSpecConfigsInner.volumeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1ComponentSpecConfigsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1alpha1ComponentSpecConfigsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1alpha1ComponentSpecConfigsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha1ComponentSpecConfigsInner is not found in the empty JSON string", V1alpha1ComponentSpecConfigsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1ComponentSpecConfigsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha1ComponentSpecConfigsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1alpha1ComponentSpecConfigsInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("legacyRenderedConfigSpec") != null && !jsonObj.get("legacyRenderedConfigSpec").isJsonNull()) {
        V1alpha1ComponentSpecConfigsInnerLegacyRenderedConfigSpec.validateJsonObject(jsonObj.getAsJsonObject("legacyRenderedConfigSpec"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1ComponentSpecConfigsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1ComponentSpecConfigsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1ComponentSpecConfigsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1ComponentSpecConfigsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1ComponentSpecConfigsInner>() {
           @Override
           public void write(JsonWriter out, V1alpha1ComponentSpecConfigsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1ComponentSpecConfigsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1alpha1ComponentSpecConfigsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1alpha1ComponentSpecConfigsInner
  * @throws IOException if the JSON string is invalid with respect to V1alpha1ComponentSpecConfigsInner
  */
  public static V1alpha1ComponentSpecConfigsInner fromJson(String jsonString) throws IOException {
    return new JSON().getGson().fromJson(jsonString, V1alpha1ComponentSpecConfigsInner.class);
  }

 /**
  * Convert an instance of V1alpha1ComponentSpecConfigsInner to an JSON string
  *
  * @return JSON string
  */
