...
import io.kubeblocks.apps.models.V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerEnvInner;
...
public class V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler {
  ...
  private List<V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerEnvInner> env;
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler() {
  }

  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler container(String container) {
  ...
  **/
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler env(List<V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerEnvInner> env) {
    
    this.env = env;
    return this;
  }

  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler addEnvItem(V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerEnvInner envItem) {
    if (this.env == null) {
  ...
  **/
  @jakarta.annotation.Nullable
  public List<V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerEnvInner> getEnv() {
    return env;
  }


  public void setEnv(List<V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerEnvInner> env) {
    this.env = env;
  }


  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler exec(V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerExec exec) {
  ...
  **/
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler http(V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerHttp http) {
  ...
  **/
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler image(String image) {
  ...
  **/
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler matchingKey(String matchingKey) {
  ...
  **/
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler preCondition(String preCondition) {
  ...
  **/
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler retryPolicy(V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerRetryPolicy retryPolicy) {
  ...
  **/
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler targetPodSelector(TargetPodSelectorEnum targetPodSelector) {
  ...
  **/
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler timeoutSeconds(Integer timeoutSeconds) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler v1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler = (V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler) o;
    return Objects.equals(this.container, v1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.container) &&
        Objects.equals(this.env, v1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.env) &&
        Objects.equals(this.exec, v1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.exec) &&
        Objects.equals(this.http, v1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.http) &&
        Objects.equals(this.image, v1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.image) &&
        Objects.equals(this.matchingKey, v1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.matchingKey) &&
        Objects.equals(this.preCondition, v1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.preCondition) &&
        Objects.equals(this.retryPolicy, v1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.retryPolicy) &&
        Objects.equals(this.targetPodSelector, v1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.targetPodSelector) &&
        Objects.equals(this.timeoutSeconds, v1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.timeoutSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler is not found in the empty JSON string", V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("env") != null && !jsonObj.get("env").isJsonNull()) {
        ...
        if (jsonArrayenv != null) {
          ...
          for (int i = 0; i < jsonArrayenv.size(); i++) {
            V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerEnvInner.validateJsonObject(jsonArrayenv.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler>() {
           @Override
           public void write(JsonWriter out, V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler
  * @throws IOException if the JSON string is invalid with respect to V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler
  */
  public static V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler fromJson(String jsonString) throws IOException {
    return new JSON().getGson().fromJson(jsonString, V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler.class);
  }

 /**
  * Convert an instance of V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler to an JSON string
  *
  * @return JSON string
  */
