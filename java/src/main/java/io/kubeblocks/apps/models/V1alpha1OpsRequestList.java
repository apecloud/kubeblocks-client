 ...
 */
@ApiModel(description = "OpsRequestList is a list of OpsRequest")
...
public class V1alpha1OpsRequestList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "List of opsrequests. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md")
