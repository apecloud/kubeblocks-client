...
import io.kubeblocks.apps.models.V1alpha1OpsRequestSpecHorizontalScalingInnerScaleOutNewInstancesInner;
...
public class V1alpha1OpsRequestSpecHorizontalScalingInnerScaleOut {
  ...
  private List<V1alpha1OpsRequestSpecHorizontalScalingInnerScaleOutNewInstancesInner> newInstances;
  ...
  **/
  ...
  public V1alpha1OpsRequestSpecHorizontalScalingInnerScaleOut newInstances(List<V1alpha1OpsRequestSpecHorizontalScalingInnerScaleOutNewInstancesInner> newInstances) {
    
    this.newInstances = newInstances;
    return this;
  }

  public V1alpha1OpsRequestSpecHorizontalScalingInnerScaleOut addNewInstancesItem(V1alpha1OpsRequestSpecHorizontalScalingInnerScaleOutNewInstancesInner newInstancesItem) {
  ...
  **/
  @jakarta.annotation.Nullable
  public List<V1alpha1OpsRequestSpecHorizontalScalingInnerScaleOutNewInstancesInner> getNewInstances() {
    return newInstances;
  }


  public void setNewInstances(List<V1alpha1OpsRequestSpecHorizontalScalingInnerScaleOutNewInstancesInner> newInstances) {
    this.newInstances = newInstances;
  }
      ...
      if (jsonObj.get("newInstances") != null && !jsonObj.get("newInstances").isJsonNull()) {
        ...
        if (jsonArraynewInstances != null) {
          ...
          for (int i = 0; i < jsonArraynewInstances.size(); i++) {
            V1alpha1OpsRequestSpecHorizontalScalingInnerScaleOutNewInstancesInner.validateJsonObject(jsonArraynewInstances.get(i).getAsJsonObject());
          };
        }
      }
