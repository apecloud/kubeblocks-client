...
public class V1alpha1OpsRequestStatus {
  ...
  **/
  ...
  public V1alpha1OpsRequestStatus conditions(List<V1alpha1OpsRequestStatusConditionsInner> conditions) {
    
    this.conditions = conditions;
    return this;
  }

  public V1alpha1OpsRequestStatus addConditionsItem(V1alpha1OpsRequestStatusConditionsInner conditionsItem) {
