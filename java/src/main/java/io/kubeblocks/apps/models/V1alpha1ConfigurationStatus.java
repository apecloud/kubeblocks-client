...
import io.kubeblocks.apps.models.V1alpha1ConfigurationStatusConditionsInner;
...
public class V1alpha1ConfigurationStatus {
  ...
  private List<V1alpha1ConfigurationStatusConditionsInner> conditions;
  ...
  public V1alpha1ConfigurationStatus conditions(List<V1alpha1ConfigurationStatusConditionsInner> conditions) {
    
    this.conditions = conditions;
    return this;
  }

  public V1alpha1ConfigurationStatus addConditionsItem(V1alpha1ConfigurationStatusConditionsInner conditionsItem) {
  ...
  **/
  ...
  public List<V1alpha1ConfigurationStatusConditionsInner> getConditions() {
    return conditions;
  }


  public void setConditions(List<V1alpha1ConfigurationStatusConditionsInner> conditions) {
    this.conditions = conditions;
  }
      ...
      if (jsonObj.get("conditions") != null && !jsonObj.get("conditions").isJsonNull()) {
        ...
        if (jsonArrayconditions != null) {
          ...
          for (int i = 0; i < jsonArrayconditions.size(); i++) {
            V1alpha1ConfigurationStatusConditionsInner.validateJsonObject(jsonArrayconditions.get(i).getAsJsonObject());
          };
        }
      }
      // ensure the json data is an array
