...
import io.kubeblocks.apps.models.V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInnerLegacyRenderedConfigSpec;
...
/**
 * V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner
 */
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-08-05T13:57:18.453647Z[Etc/UTC]")
public class V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner {
  ...
  private V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInnerLegacyRenderedConfigSpec legacyRenderedConfigSpec;
  ...
  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner() {
  }

  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner asEnvFrom(List<String> asEnvFrom) {
    
    this.asEnvFrom = asEnvFrom;
    return this;
  }

  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner addAsEnvFromItem(String asEnvFromItem) {
  ...
  **/
  ...
  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner constraintRef(String constraintRef) {
  ...
  **/
  ...
  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner defaultMode(Integer defaultMode) {
  ...
  **/
  ...
  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner injectEnvTo(List<String> injectEnvTo) {
    
    this.injectEnvTo = injectEnvTo;
    return this;
  }

  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner addInjectEnvToItem(String injectEnvToItem) {
  ...
  **/
  ...
  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner keys(List<String> keys) {
    
    this.keys = keys;
    return this;
  }

  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner addKeysItem(String keysItem) {
    if (this.keys == null) {
  ...
  **/
  ...
  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner legacyRenderedConfigSpec(V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInnerLegacyRenderedConfigSpec legacyRenderedConfigSpec) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInnerLegacyRenderedConfigSpec getLegacyRenderedConfigSpec() {
    return legacyRenderedConfigSpec;
  }


  public void setLegacyRenderedConfigSpec(V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInnerLegacyRenderedConfigSpec legacyRenderedConfigSpec) {
    this.legacyRenderedConfigSpec = legacyRenderedConfigSpec;
  }


  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner name(String name) {
  ...
  **/
  ...
  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner namespace(String namespace) {
  ...
  **/
  ...
  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner reRenderResourceTypes(List<ReRenderResourceTypesEnum> reRenderResourceTypes) {
    
    this.reRenderResourceTypes = reRenderResourceTypes;
    return this;
  }

  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner addReRenderResourceTypesItem(ReRenderResourceTypesEnum reRenderResourceTypesItem) {
  ...
  **/
  ...
  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner templateRef(String templateRef) {
  ...
  **/
  ...
  public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner volumeName(String volumeName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner = (V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner) o;
    return Objects.equals(this.asEnvFrom, v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.asEnvFrom) &&
        Objects.equals(this.constraintRef, v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.constraintRef) &&
        Objects.equals(this.defaultMode, v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.defaultMode) &&
        Objects.equals(this.injectEnvTo, v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.injectEnvTo) &&
        Objects.equals(this.keys, v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.keys) &&
        Objects.equals(this.legacyRenderedConfigSpec, v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.legacyRenderedConfigSpec) &&
        Objects.equals(this.name, v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.name) &&
        Objects.equals(this.namespace, v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.namespace) &&
        Objects.equals(this.reRenderResourceTypes, v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.reRenderResourceTypes) &&
        Objects.equals(this.templateRef, v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.templateRef) &&
        Objects.equals(this.volumeName, v1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.volumeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner is not found in the empty JSON string", V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("legacyRenderedConfigSpec") != null && !jsonObj.get("legacyRenderedConfigSpec").isJsonNull()) {
        V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInnerLegacyRenderedConfigSpec.validateJsonObject(jsonObj.getAsJsonObject("legacyRenderedConfigSpec"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner>() {
           @Override
           public void write(JsonWriter out, V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner
  * @throws IOException if the JSON string is invalid with respect to V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner
  */
  public static V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner fromJson(String jsonString) throws IOException {
    return new JSON().getGson().fromJson(jsonString, V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.class);
  }

 /**
  * Convert an instance of V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner to an JSON string
  *
  * @return JSON string
  */
