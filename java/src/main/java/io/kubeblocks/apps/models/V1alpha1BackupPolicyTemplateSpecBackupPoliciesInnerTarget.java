...
public class V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget {
  ...
  public V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget() {
  }

  public V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget account(String account) {
  ...
  **/
  ...
  public V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget connectionCredentialKey(V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerBackupMethodsInnerTargetConnectionCredentialKey connectionCredentialKey) {
  ...
  **/
  ...
  public V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget role(String role) {
  ...
  **/
  ...
  public V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget strategy(StrategyEnum strategy) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget v1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget = (V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget) o;
    return Objects.equals(this.account, v1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget.account) &&
        Objects.equals(this.connectionCredentialKey, v1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget.connectionCredentialKey) &&
        Objects.equals(this.role, v1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget.role) &&
        Objects.equals(this.strategy, v1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget.strategy);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget is not found in the empty JSON string", V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget>() {
           @Override
           public void write(JsonWriter out, V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget
  * @throws IOException if the JSON string is invalid with respect to V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget
  */
  public static V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget fromJson(String jsonString) throws IOException {
    return new JSON().getGson().fromJson(jsonString, V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget.class);
  }

 /**
  * Convert an instance of V1alpha1BackupPolicyTemplateSpecBackupPoliciesInnerTarget to an JSON string
  *
  * @return JSON string
  */
