...
public class V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverWithoutCandidate {
  ...
  **/
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverWithoutCandidate env(List<V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerEnvInner> env) {
    
    this.env = env;
    return this;
  }

  public V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverWithoutCandidate addEnvItem(V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerEnvInner envItem) {
    if (this.env == null) {
