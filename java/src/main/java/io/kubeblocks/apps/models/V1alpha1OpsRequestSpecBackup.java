...
public class V1alpha1OpsRequestSpecBackup {
  ...
  public V1alpha1OpsRequestSpecBackup() {
  }

  public V1alpha1OpsRequestSpecBackup backupMethod(String backupMethod) {
  ...
  **/
  ...
  public V1alpha1OpsRequestSpecBackup backupName(String backupName) {
  ...
  **/
  ...
  public V1alpha1OpsRequestSpecBackup backupPolicyName(String backupPolicyName) {
  ...
  **/
  ...
  public V1alpha1OpsRequestSpecBackup deletionPolicy(DeletionPolicyEnum deletionPolicy) {
  ...
  **/
  ...
  public V1alpha1OpsRequestSpecBackup parentBackupName(String parentBackupName) {
  ...
  **/
  ...
  public V1alpha1OpsRequestSpecBackup retentionPeriod(String retentionPeriod) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1OpsRequestSpecBackup v1alpha1OpsRequestSpecBackup = (V1alpha1OpsRequestSpecBackup) o;
    return Objects.equals(this.backupMethod, v1alpha1OpsRequestSpecBackup.backupMethod) &&
        Objects.equals(this.backupName, v1alpha1OpsRequestSpecBackup.backupName) &&
        Objects.equals(this.backupPolicyName, v1alpha1OpsRequestSpecBackup.backupPolicyName) &&
        Objects.equals(this.deletionPolicy, v1alpha1OpsRequestSpecBackup.deletionPolicy) &&
        Objects.equals(this.parentBackupName, v1alpha1OpsRequestSpecBackup.parentBackupName) &&
        Objects.equals(this.retentionPeriod, v1alpha1OpsRequestSpecBackup.retentionPeriod);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1OpsRequestSpecBackup {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1alpha1OpsRequestSpecBackup
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1alpha1OpsRequestSpecBackup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha1OpsRequestSpecBackup is not found in the empty JSON string", V1alpha1OpsRequestSpecBackup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1OpsRequestSpecBackup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha1OpsRequestSpecBackup` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1OpsRequestSpecBackup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1OpsRequestSpecBackup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1OpsRequestSpecBackup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1OpsRequestSpecBackup.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1OpsRequestSpecBackup>() {
           @Override
           public void write(JsonWriter out, V1alpha1OpsRequestSpecBackup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1OpsRequestSpecBackup read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1alpha1OpsRequestSpecBackup given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1alpha1OpsRequestSpecBackup
  * @throws IOException if the JSON string is invalid with respect to V1alpha1OpsRequestSpecBackup
  */
  public static V1alpha1OpsRequestSpecBackup fromJson(String jsonString) throws IOException {
    return new JSON().getGson().fromJson(jsonString, V1alpha1OpsRequestSpecBackup.class);
  }

 /**
  * Convert an instance of V1alpha1OpsRequestSpecBackup to an JSON string
  *
  * @return JSON string
  */
