...
/**
 * Defines the environment variables that need to be referenced from the target component pod and will be injected into the job&#39;s containers. If this field is set, the global \&quot;varsRef\&quot; will be ignored.
 */
...
public class V1alpha1OpsDefinitionSpecComponentDefinitionRefsInnerVarsRef {
  ...
  */
  public static V1alpha1OpsDefinitionSpecComponentDefinitionRefsInnerVarsRef fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1alpha1OpsDefinitionSpecComponentDefinitionRefsInnerVarsRef.class);
  }
