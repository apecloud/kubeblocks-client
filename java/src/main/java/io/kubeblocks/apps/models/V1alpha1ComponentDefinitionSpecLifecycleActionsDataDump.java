...
public class V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump {
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump() {
  }

  public V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump builtinHandler(String builtinHandler) {
  ...
  **/
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump customHandler(V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandler customHandler) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump v1alpha1ComponentDefinitionSpecLifecycleActionsDataDump = (V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump) o;
    return Objects.equals(this.builtinHandler, v1alpha1ComponentDefinitionSpecLifecycleActionsDataDump.builtinHandler) &&
        Objects.equals(this.customHandler, v1alpha1ComponentDefinitionSpecLifecycleActionsDataDump.customHandler);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump is not found in the empty JSON string", V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump>() {
           @Override
           public void write(JsonWriter out, V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump
  * @throws IOException if the JSON string is invalid with respect to V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump
  */
  public static V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump fromJson(String jsonString) throws IOException {
    return new JSON().getGson().fromJson(jsonString, V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump.class);
  }

 /**
  * Convert an instance of V1alpha1ComponentDefinitionSpecLifecycleActionsDataDump to an JSON string
  *
  * @return JSON string
  */
