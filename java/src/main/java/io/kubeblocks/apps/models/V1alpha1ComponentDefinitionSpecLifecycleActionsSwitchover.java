...
import io.kubeblocks.apps.models.V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverScriptSpecSelectorsInner;
...
public class V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchover {
  ...
  private List<V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverScriptSpecSelectorsInner> scriptSpecSelectors;
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchover scriptSpecSelectors(List<V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverScriptSpecSelectorsInner> scriptSpecSelectors) {
    
    this.scriptSpecSelectors = scriptSpecSelectors;
    return this;
  }

  public V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchover addScriptSpecSelectorsItem(V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverScriptSpecSelectorsInner scriptSpecSelectorsItem) {
  ...
  **/
  ...
  public List<V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverScriptSpecSelectorsInner> getScriptSpecSelectors() {
    return scriptSpecSelectors;
  }


  public void setScriptSpecSelectors(List<V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverScriptSpecSelectorsInner> scriptSpecSelectors) {
    this.scriptSpecSelectors = scriptSpecSelectors;
  }
      ...
      if (jsonObj.get("scriptSpecSelectors") != null && !jsonObj.get("scriptSpecSelectors").isJsonNull()) {
        ...
        if (jsonArrayscriptSpecSelectors != null) {
          ...
          for (int i = 0; i < jsonArrayscriptSpecSelectors.size(); i++) {
            V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverScriptSpecSelectorsInner.validateJsonObject(jsonArrayscriptSpecSelectors.get(i).getAsJsonObject());
          };
        }
      }
