...
public class V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverWithCandidate {
  ...
  **/
  ...
  public V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverWithCandidate env(List<V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerEnvInner> env) {
    
    this.env = env;
    return this;
  }

  public V1alpha1ComponentDefinitionSpecLifecycleActionsSwitchoverWithCandidate addEnvItem(V1alpha1ComponentDefinitionSpecLifecycleActionsAccountProvisionCustomHandlerEnvInner envItem) {
    if (this.env == null) {
