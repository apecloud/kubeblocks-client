...
import io.kubeblocks.apps.models.V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpecLegacyRenderedConfigSpec;
...
public class V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpec {
  ...
  private V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpecLegacyRenderedConfigSpec legacyRenderedConfigSpec;
  ...
  **/
  ...
  public V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpec injectEnvTo(List<String> injectEnvTo) {
    
    this.injectEnvTo = injectEnvTo;
    return this;
  }

  public V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpec addInjectEnvToItem(String injectEnvToItem) {
  ...
  **/
  ...
  public V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpec legacyRenderedConfigSpec(V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpecLegacyRenderedConfigSpec legacyRenderedConfigSpec) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpecLegacyRenderedConfigSpec getLegacyRenderedConfigSpec() {
    return legacyRenderedConfigSpec;
  }


  public void setLegacyRenderedConfigSpec(V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpecLegacyRenderedConfigSpec legacyRenderedConfigSpec) {
    this.legacyRenderedConfigSpec = legacyRenderedConfigSpec;
  }
  ...
  **/
  ...
  public V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpec reRenderResourceTypes(List<ReRenderResourceTypesEnum> reRenderResourceTypes) {
    
    this.reRenderResourceTypes = reRenderResourceTypes;
    return this;
  }

  public V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpec addReRenderResourceTypesItem(ReRenderResourceTypesEnum reRenderResourceTypesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.asEnvFrom, v1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpec.asEnvFrom) &&
        ...
        Objects.equals(this.injectEnvTo, v1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpec.injectEnvTo) &&
        ...
        Objects.equals(this.reRenderResourceTypes, v1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpec.reRenderResourceTypes) &&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("legacyRenderedConfigSpec") != null && !jsonObj.get("legacyRenderedConfigSpec").isJsonNull()) {
        V1alpha1ConfigurationSpecConfigItemDetailsInnerConfigSpecLegacyRenderedConfigSpec.validateJsonObject(jsonObj.getAsJsonObject("legacyRenderedConfigSpec"));
      }
