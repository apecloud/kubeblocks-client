...
public class V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity {
  ...
  public V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity() {
  }

  public V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity preferredDuringSchedulingIgnoredDuringExecution(List<V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionInner> preferredDuringSchedulingIgnoredDuringExecution) {
    
    this.preferredDuringSchedulingIgnoredDuringExecution = preferredDuringSchedulingIgnoredDuringExecution;
    return this;
  }

  public V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity addPreferredDuringSchedulingIgnoredDuringExecutionItem(V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionInner preferredDuringSchedulingIgnoredDuringExecutionItem) {
  ...
  **/
  ...
  public V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity requiredDuringSchedulingIgnoredDuringExecution(List<V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionInner> requiredDuringSchedulingIgnoredDuringExecution) {
    
    this.requiredDuringSchedulingIgnoredDuringExecution = requiredDuringSchedulingIgnoredDuringExecution;
    return this;
  }

  public V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity addRequiredDuringSchedulingIgnoredDuringExecutionItem(V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionInner requiredDuringSchedulingIgnoredDuringExecutionItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity v1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity = (V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity) o;
    return Objects.equals(this.preferredDuringSchedulingIgnoredDuringExecution, v1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution) &&
        Objects.equals(this.requiredDuringSchedulingIgnoredDuringExecution, v1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity.requiredDuringSchedulingIgnoredDuringExecution);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity is not found in the empty JSON string", V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity>() {
           @Override
           public void write(JsonWriter out, V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity
  * @throws IOException if the JSON string is invalid with respect to V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity
  */
  public static V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity fromJson(String jsonString) throws IOException {
    return new JSON().getGson().fromJson(jsonString, V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity.class);
  }

 /**
  * Convert an instance of V1alpha1ClusterSpecComponentSpecsInnerInstancesInnerSchedulingPolicyAffinityPodAntiAffinity to an JSON string
  *
  * @return JSON string
  */
