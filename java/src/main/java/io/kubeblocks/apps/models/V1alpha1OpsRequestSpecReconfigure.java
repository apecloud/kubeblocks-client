...
public class V1alpha1OpsRequestSpecReconfigure {
  ...
  **/
  ...
  public V1alpha1OpsRequestSpecReconfigure configurations(List<V1alpha1OpsRequestSpecReconfigureConfigurations> configurations) {
    
    this.configurations = configurations;
    return this;
  }

  public V1alpha1OpsRequestSpecReconfigure addConfigurationsItem(V1alpha1OpsRequestSpecReconfigureConfigurations configurationsItem) {
