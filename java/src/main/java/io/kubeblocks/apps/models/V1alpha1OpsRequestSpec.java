...
public class V1alpha1OpsRequestSpec {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backup, backupSpec, cancel, clusterName, clusterRef, custom, expose, force, horizontalScaling, preConditionDeadlineSeconds, rebuildFrom, reconfigure, reconfigures, restart, restore, restoreSpec, scriptSpec, switchover, timeoutSeconds, ttlSecondsAfterSucceed, type, upgrade, verticalScaling, volumeExpansion);
  }
