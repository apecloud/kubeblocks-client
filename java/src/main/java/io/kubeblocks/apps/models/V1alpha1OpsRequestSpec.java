...
public class V1alpha1OpsRequestSpec {
  ...
  public static final String SERIALIZED_NAME_TTL_SECONDS_AFTER_UNSUCCESSFUL_COMPLETION = "ttlSecondsAfterUnsuccessfulCompletion";
  @SerializedName(SERIALIZED_NAME_TTL_SECONDS_AFTER_UNSUCCESSFUL_COMPLETION)
  private Integer ttlSecondsAfterUnsuccessfulCompletion;
  ...
  **/
  ...
  public V1alpha1OpsRequestSpec timeoutSeconds(Integer timeoutSeconds) {
  ...
  **/
  ...
  public V1alpha1OpsRequestSpec ttlSecondsAfterUnsuccessfulCompletion(Integer ttlSecondsAfterUnsuccessfulCompletion) {
    
    this.ttlSecondsAfterUnsuccessfulCompletion = ttlSecondsAfterUnsuccessfulCompletion;
    return this;
  }
   ...
   * @return ttlSecondsAfterUnsuccessfulCompletion
  **/
  @jakarta.annotation.Nullable
  public Integer getTtlSecondsAfterUnsuccessfulCompletion() {
    return ttlSecondsAfterUnsuccessfulCompletion;
  }


  public void setTtlSecondsAfterUnsuccessfulCompletion(Integer ttlSecondsAfterUnsuccessfulCompletion) {
    this.ttlSecondsAfterUnsuccessfulCompletion = ttlSecondsAfterUnsuccessfulCompletion;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backup, v1alpha1OpsRequestSpec.backup) &&
        ...
        Objects.equals(this.timeoutSeconds, v1alpha1OpsRequestSpec.timeoutSeconds) &&
        Objects.equals(this.ttlSecondsAfterSucceed, v1alpha1OpsRequestSpec.ttlSecondsAfterSucceed) &&
        Objects.equals(this.ttlSecondsAfterUnsuccessfulCompletion, v1alpha1OpsRequestSpec.ttlSecondsAfterUnsuccessfulCompletion) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backup, backupSpec, cancel, clusterName, clusterRef, custom, expose, force, horizontalScaling, preConditionDeadlineSeconds, rebuildFrom, reconfigure, reconfigures, restart, restore, restoreSpec, scriptSpec, switchover, timeoutSeconds, ttlSecondsAfterSucceed, ttlSecondsAfterUnsuccessfulCompletion, type, upgrade, verticalScaling, volumeExpansion);
  }
  ...
  public String toString() {
    ...
    sb.append("    ttlSecondsAfterUnsuccessfulCompletion: ").append(toIndentedString(ttlSecondsAfterUnsuccessfulCompletion)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ttlSecondsAfterUnsuccessfulCompletion");
