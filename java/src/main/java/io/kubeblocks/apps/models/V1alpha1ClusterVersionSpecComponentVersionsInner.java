...
import io.kubeblocks.apps.models.V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner;
...
/**
 * ClusterComponentVersion is an application version component spec.   Deprecated since v0.9. This struct is maintained for backward compatibility and its use is discouraged.
 */
...
public class V1alpha1ClusterVersionSpecComponentVersionsInner {
  ...
  private List<V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner> configSpecs;
  ...
  **/
  ...
  public V1alpha1ClusterVersionSpecComponentVersionsInner configSpecs(List<V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner> configSpecs) {
    
    this.configSpecs = configSpecs;
    return this;
  }

  public V1alpha1ClusterVersionSpecComponentVersionsInner addConfigSpecsItem(V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner configSpecsItem) {
  ...
  **/
  ...
  public List<V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner> getConfigSpecs() {
    return configSpecs;
  }


  public void setConfigSpecs(List<V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner> configSpecs) {
    this.configSpecs = configSpecs;
  }
      ...
      if (jsonObj.get("configSpecs") != null && !jsonObj.get("configSpecs").isJsonNull()) {
        ...
        if (jsonArrayconfigSpecs != null) {
          ...
          for (int i = 0; i < jsonArrayconfigSpecs.size(); i++) {
            V1alpha1ClusterVersionSpecComponentVersionsInnerConfigSpecsInner.validateJsonObject(jsonArrayconfigSpecs.get(i).getAsJsonObject());
          };
        }
      }
