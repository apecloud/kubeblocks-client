...
public class V1alpha1BackupStatusTarget {
  ...
  public V1alpha1BackupStatusTarget() {
  }

  public V1alpha1BackupStatusTarget connectionCredential(V1alpha1BackupStatusBackupMethodTargetConnectionCredential connectionCredential) {
  ...
  **/
  ...
  public V1alpha1BackupStatusTarget name(String name) {
  ...
  **/
  ...
  public V1alpha1BackupStatusTarget podSelector(V1alpha1BackupStatusBackupMethodTargetPodSelector podSelector) {
  ...
  **/
  ...
  public V1alpha1BackupStatusTarget resources(V1alpha1BackupStatusBackupMethodTargetResources resources) {
  ...
  **/
  ...
  public V1alpha1BackupStatusTarget selectedTargetPods(List<String> selectedTargetPods) {
    
    this.selectedTargetPods = selectedTargetPods;
    return this;
  }

  public V1alpha1BackupStatusTarget addSelectedTargetPodsItem(String selectedTargetPodsItem) {
  ...
  **/
  ...
  public V1alpha1BackupStatusTarget serviceAccountName(String serviceAccountName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1BackupStatusTarget v1alpha1BackupStatusTarget = (V1alpha1BackupStatusTarget) o;
    return Objects.equals(this.connectionCredential, v1alpha1BackupStatusTarget.connectionCredential) &&
        Objects.equals(this.name, v1alpha1BackupStatusTarget.name) &&
        Objects.equals(this.podSelector, v1alpha1BackupStatusTarget.podSelector) &&
        Objects.equals(this.resources, v1alpha1BackupStatusTarget.resources) &&
        Objects.equals(this.selectedTargetPods, v1alpha1BackupStatusTarget.selectedTargetPods) &&
        Objects.equals(this.serviceAccountName, v1alpha1BackupStatusTarget.serviceAccountName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1BackupStatusTarget {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1alpha1BackupStatusTarget
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1alpha1BackupStatusTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha1BackupStatusTarget is not found in the empty JSON string", V1alpha1BackupStatusTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1BackupStatusTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha1BackupStatusTarget` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1BackupStatusTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1BackupStatusTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1BackupStatusTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1BackupStatusTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1BackupStatusTarget>() {
           @Override
           public void write(JsonWriter out, V1alpha1BackupStatusTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1BackupStatusTarget read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1alpha1BackupStatusTarget given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1alpha1BackupStatusTarget
  * @throws IOException if the JSON string is invalid with respect to V1alpha1BackupStatusTarget
  */
  public static V1alpha1BackupStatusTarget fromJson(String jsonString) throws IOException {
    return new JSON().getGson().fromJson(jsonString, V1alpha1BackupStatusTarget.class);
  }

 /**
  * Convert an instance of V1alpha1BackupStatusTarget to an JSON string
  *
  * @return JSON string
  */
