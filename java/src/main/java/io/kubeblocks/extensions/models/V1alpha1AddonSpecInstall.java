...
public class V1alpha1AddonSpecInstall {
  ...
  public V1alpha1AddonSpecInstall() {
  }

  public V1alpha1AddonSpecInstall enabled(Boolean enabled) {
  ...
  **/
  ...
  public V1alpha1AddonSpecInstall extras(List<V1alpha1AddonSpecDefaultInstallValuesInnerExtrasInner> extras) {
    
    this.extras = extras;
    return this;
  }

  public V1alpha1AddonSpecInstall addExtrasItem(V1alpha1AddonSpecDefaultInstallValuesInnerExtrasInner extrasItem) {
    if (this.extras == null) {
  ...
  **/
  ...
  public V1alpha1AddonSpecInstall persistentVolumeEnabled(Boolean persistentVolumeEnabled) {
  ...
  **/
  ...
  public V1alpha1AddonSpecInstall replicas(Integer replicas) {
  ...
  **/
  ...
  public V1alpha1AddonSpecInstall resources(V1alpha1AddonSpecDefaultInstallValuesInnerExtrasInnerResources resources) {
  ...
  **/
  ...
  public V1alpha1AddonSpecInstall storageClass(String storageClass) {
  ...
  **/
  ...
  public V1alpha1AddonSpecInstall tolerations(String tolerations) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1AddonSpecInstall v1alpha1AddonSpecInstall = (V1alpha1AddonSpecInstall) o;
    return Objects.equals(this.enabled, v1alpha1AddonSpecInstall.enabled) &&
        Objects.equals(this.extras, v1alpha1AddonSpecInstall.extras) &&
        Objects.equals(this.persistentVolumeEnabled, v1alpha1AddonSpecInstall.persistentVolumeEnabled) &&
        Objects.equals(this.replicas, v1alpha1AddonSpecInstall.replicas) &&
        Objects.equals(this.resources, v1alpha1AddonSpecInstall.resources) &&
        Objects.equals(this.storageClass, v1alpha1AddonSpecInstall.storageClass) &&
        Objects.equals(this.tolerations, v1alpha1AddonSpecInstall.tolerations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, extras, persistentVolumeEnabled, replicas, resources, storageClass, tolerations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1alpha1AddonSpecInstall {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1alpha1AddonSpecInstall
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1alpha1AddonSpecInstall.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha1AddonSpecInstall is not found in the empty JSON string", V1alpha1AddonSpecInstall.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1AddonSpecInstall.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha1AddonSpecInstall` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1AddonSpecInstall.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1AddonSpecInstall' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1AddonSpecInstall> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1AddonSpecInstall.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1AddonSpecInstall>() {
           @Override
           public void write(JsonWriter out, V1alpha1AddonSpecInstall value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1AddonSpecInstall read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1alpha1AddonSpecInstall given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1alpha1AddonSpecInstall
  * @throws IOException if the JSON string is invalid with respect to V1alpha1AddonSpecInstall
  */
  public static V1alpha1AddonSpecInstall fromJson(String jsonString) throws IOException {
    return new JSON().getGson().fromJson(jsonString, V1alpha1AddonSpecInstall.class);
  }

 /**
  * Convert an instance of V1alpha1AddonSpecInstall to an JSON string
  *
  * @return JSON string
  */
