...
import io.kubeblocks.workloads.models.V1alpha1InstanceSetSpecRoleProbeCustomHandlerInner;
...
public class V1alpha1InstanceSetSpecRoleProbe {
  ...
  private List<V1alpha1InstanceSetSpecRoleProbeCustomHandlerInner> customHandler;
  ...
  public V1alpha1InstanceSetSpecRoleProbe() {
  }

  public V1alpha1InstanceSetSpecRoleProbe builtinHandlerName(String builtinHandlerName) {
  ...
  **/
  ...
  public V1alpha1InstanceSetSpecRoleProbe customHandler(List<V1alpha1InstanceSetSpecRoleProbeCustomHandlerInner> customHandler) {
    
    this.customHandler = customHandler;
    return this;
  }

  public V1alpha1InstanceSetSpecRoleProbe addCustomHandlerItem(V1alpha1InstanceSetSpecRoleProbeCustomHandlerInner customHandlerItem) {
  ...
  **/
  @jakarta.annotation.Nullable
  public List<V1alpha1InstanceSetSpecRoleProbeCustomHandlerInner> getCustomHandler() {
    return customHandler;
  }


  public void setCustomHandler(List<V1alpha1InstanceSetSpecRoleProbeCustomHandlerInner> customHandler) {
    this.customHandler = customHandler;
  }


  public V1alpha1InstanceSetSpecRoleProbe failureThreshold(Integer failureThreshold) {
  ...
  **/
  ...
  public V1alpha1InstanceSetSpecRoleProbe initialDelaySeconds(Integer initialDelaySeconds) {
  ...
  **/
  ...
  public V1alpha1InstanceSetSpecRoleProbe periodSeconds(Integer periodSeconds) {
  ...
  **/
  ...
  public V1alpha1InstanceSetSpecRoleProbe roleUpdateMechanism(RoleUpdateMechanismEnum roleUpdateMechanism) {
  ...
  **/
  ...
  public V1alpha1InstanceSetSpecRoleProbe successThreshold(Integer successThreshold) {
  ...
  **/
  ...
  public V1alpha1InstanceSetSpecRoleProbe timeoutSeconds(Integer timeoutSeconds) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1InstanceSetSpecRoleProbe v1alpha1InstanceSetSpecRoleProbe = (V1alpha1InstanceSetSpecRoleProbe) o;
    return Objects.equals(this.builtinHandlerName, v1alpha1InstanceSetSpecRoleProbe.builtinHandlerName) &&
        Objects.equals(this.customHandler, v1alpha1InstanceSetSpecRoleProbe.customHandler) &&
        Objects.equals(this.failureThreshold, v1alpha1InstanceSetSpecRoleProbe.failureThreshold) &&
        Objects.equals(this.initialDelaySeconds, v1alpha1InstanceSetSpecRoleProbe.initialDelaySeconds) &&
        Objects.equals(this.periodSeconds, v1alpha1InstanceSetSpecRoleProbe.periodSeconds) &&
        Objects.equals(this.roleUpdateMechanism, v1alpha1InstanceSetSpecRoleProbe.roleUpdateMechanism) &&
        Objects.equals(this.successThreshold, v1alpha1InstanceSetSpecRoleProbe.successThreshold) &&
        Objects.equals(this.timeoutSeconds, v1alpha1InstanceSetSpecRoleProbe.timeoutSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1InstanceSetSpecRoleProbe {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1alpha1InstanceSetSpecRoleProbe
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1alpha1InstanceSetSpecRoleProbe.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha1InstanceSetSpecRoleProbe is not found in the empty JSON string", V1alpha1InstanceSetSpecRoleProbe.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1InstanceSetSpecRoleProbe.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha1InstanceSetSpecRoleProbe` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("customHandler") != null && !jsonObj.get("customHandler").isJsonNull()) {
        ...
        if (jsonArraycustomHandler != null) {
          ...
          for (int i = 0; i < jsonArraycustomHandler.size(); i++) {
            V1alpha1InstanceSetSpecRoleProbeCustomHandlerInner.validateJsonObject(jsonArraycustomHandler.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1InstanceSetSpecRoleProbe.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1InstanceSetSpecRoleProbe' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1InstanceSetSpecRoleProbe> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1InstanceSetSpecRoleProbe.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1InstanceSetSpecRoleProbe>() {
           @Override
           public void write(JsonWriter out, V1alpha1InstanceSetSpecRoleProbe value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1InstanceSetSpecRoleProbe read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1alpha1InstanceSetSpecRoleProbe given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1alpha1InstanceSetSpecRoleProbe
  * @throws IOException if the JSON string is invalid with respect to V1alpha1InstanceSetSpecRoleProbe
  */
  public static V1alpha1InstanceSetSpecRoleProbe fromJson(String jsonString) throws IOException {
    return new JSON().getGson().fromJson(jsonString, V1alpha1InstanceSetSpecRoleProbe.class);
  }

 /**
  * Convert an instance of V1alpha1InstanceSetSpecRoleProbe to an JSON string
  *
  * @return JSON string
  */
