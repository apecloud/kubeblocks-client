...
public class V1alpha1InstanceSetSpecCredentialPasswordValueFrom {
  ...
  public V1alpha1InstanceSetSpecCredentialPasswordValueFrom() {
  }

  public V1alpha1InstanceSetSpecCredentialPasswordValueFrom configMapKeyRef(V1alpha1InstanceSetSpecCredentialPasswordValueFromConfigMapKeyRef configMapKeyRef) {
  ...
  **/
  ...
  public V1alpha1InstanceSetSpecCredentialPasswordValueFrom fieldRef(V1alpha1InstanceSetSpecCredentialPasswordValueFromFieldRef fieldRef) {
  ...
  **/
  ...
  public V1alpha1InstanceSetSpecCredentialPasswordValueFrom resourceFieldRef(V1alpha1InstanceSetSpecCredentialPasswordValueFromResourceFieldRef resourceFieldRef) {
  ...
  **/
  ...
  public V1alpha1InstanceSetSpecCredentialPasswordValueFrom secretKeyRef(V1alpha1InstanceSetSpecCredentialPasswordValueFromSecretKeyRef secretKeyRef) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1InstanceSetSpecCredentialPasswordValueFrom v1alpha1InstanceSetSpecCredentialPasswordValueFrom = (V1alpha1InstanceSetSpecCredentialPasswordValueFrom) o;
    return Objects.equals(this.configMapKeyRef, v1alpha1InstanceSetSpecCredentialPasswordValueFrom.configMapKeyRef) &&
        Objects.equals(this.fieldRef, v1alpha1InstanceSetSpecCredentialPasswordValueFrom.fieldRef) &&
        Objects.equals(this.resourceFieldRef, v1alpha1InstanceSetSpecCredentialPasswordValueFrom.resourceFieldRef) &&
        Objects.equals(this.secretKeyRef, v1alpha1InstanceSetSpecCredentialPasswordValueFrom.secretKeyRef);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1InstanceSetSpecCredentialPasswordValueFrom {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1alpha1InstanceSetSpecCredentialPasswordValueFrom
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1alpha1InstanceSetSpecCredentialPasswordValueFrom.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1alpha1InstanceSetSpecCredentialPasswordValueFrom is not found in the empty JSON string", V1alpha1InstanceSetSpecCredentialPasswordValueFrom.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1alpha1InstanceSetSpecCredentialPasswordValueFrom.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1alpha1InstanceSetSpecCredentialPasswordValueFrom` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1alpha1InstanceSetSpecCredentialPasswordValueFrom.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1alpha1InstanceSetSpecCredentialPasswordValueFrom' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1alpha1InstanceSetSpecCredentialPasswordValueFrom> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1alpha1InstanceSetSpecCredentialPasswordValueFrom.class));

       return (TypeAdapter<T>) new TypeAdapter<V1alpha1InstanceSetSpecCredentialPasswordValueFrom>() {
           @Override
           public void write(JsonWriter out, V1alpha1InstanceSetSpecCredentialPasswordValueFrom value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1alpha1InstanceSetSpecCredentialPasswordValueFrom read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1alpha1InstanceSetSpecCredentialPasswordValueFrom given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1alpha1InstanceSetSpecCredentialPasswordValueFrom
  * @throws IOException if the JSON string is invalid with respect to V1alpha1InstanceSetSpecCredentialPasswordValueFrom
  */
  public static V1alpha1InstanceSetSpecCredentialPasswordValueFrom fromJson(String jsonString) throws IOException {
    return new JSON().getGson().fromJson(jsonString, V1alpha1InstanceSetSpecCredentialPasswordValueFrom.class);
  }

 /**
  * Convert an instance of V1alpha1InstanceSetSpecCredentialPasswordValueFrom to an JSON string
  *
  * @return JSON string
  */
